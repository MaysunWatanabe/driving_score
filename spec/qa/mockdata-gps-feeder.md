<!-- 作成: 2026-08-31 16:33:18 JST | 更新: 2026-09-10 17:38:58 JST -->

```json
{
  "required_changes": [
    {"node": "qa.mockdata.gps.feeder", "entrypoint": "spec/qa/mockdata-gps-feeder.md", "description": "承認済みファクト(1)〜(6)を仕様本文に確定反映し、禁止オプション・欠落即失敗・gps限定・クリーンアップ順序を独立テストケース化する"}
  ],
  "suggested_impacts": [
